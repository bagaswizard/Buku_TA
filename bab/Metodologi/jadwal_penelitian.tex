...
\begin{enumerate}
  \item \textbf{Studi Literatur} \newline Tahap awal ini akan fokus pada
  ...
  \item \textbf{Perancangan Sistem} \newline Pada tahap ini, struktur
  ...
  \item \textbf{Perancangan Lingkungan Simulasi} \newline Lingkungan simulasi
  ...
  \item \textbf{Implementasi Navigasi} \newline Modul \emph{layered costmap}
  ...
  \item \textbf{Uji Coba dan Evaluasi} \newline Pengujian akan dilakukan untuk
  ...
  \item \textbf{Analisis Hasil} \newline Data yang terkumpul dari tahap uji
  ...
  \item \textbf{Penyusunan Laporan} \newline Seluruh hasil penelitian, mulai
