...
Sensor LiDAR 2D pada lingkungan simulasi dikonfigurasi untuk mendeteksi rintangan di sekitar robot secara \emph{real-time}. Sensor bekerja dengan memancarkan sinar laser virtual dan mengukur jarak ke objek di sekitarnya. Data hasil pembacaan digunakan sebagai masukan untuk membentuk \emph{costmap} dan deteksi rintangan pada sistem navigasi. LiDAR yang digunakana adalah YDLiDAR T-mini-plus yang ditunjuk pada gambar \ref{fig:ydlidar}. LiDAR yang digunakan dalam simulasi disetarakan dengan spesifikasi YDLiDAR T-mini-plus, yaitu frekuensi \emph{scan} 12 Hz, \emph{scan angle} $360^\circ$, resolusi sudut $0.54^\circ$, dan jarak maksimum 12 m.
...
\begin{subfigure}{0.45\textwidth}
\centering
\includegraphics[scale=0.1]{gambar/BNO080.jpg}
