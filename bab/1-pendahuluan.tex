...
Metode \emph{layered costmap} yang diusulkan dalam tugas akhir telah digunakan sebagai bagian dari sistem navigasi robot otonom pada penelitian-penelitian terdahulu. Perbedaan di sini terletak pada penambahan \emph{layer} baru yang digunakan pada navigasi robot di lingkungan bertingkat, di mana belum dieksplorasi pada penelitian sebelumnya. Selain
itu, navigasi antar lantai juga pernah dilakukan pada studi terdahulu
namun, penelitian tersebut umumnya memisahkan peta tiap lantai pada file masing-masing. Berbeda dengan pendekatan tersebut, tugas akhir ini mengajukan
metode dengan menggunakan satu peta gabungan (\emph{combined map}) yang
menyatukan seluruh region ke dalam satu representasi \emph{costmap} 2D.
...
\begin{enumerate}
  \item Pengujian dilakukan pada simulasi yang didesain untuk merekayasa kondisi pasca gempa. Arena dilengkapi dengan rekayasa rintangan tidak diketahui dan permukaan tidak rata, yang dibuat pada skala lebih kecil. 
...
\begin{enumerate}
  ...
  \item Metode \emph{layered costmap} yang diusulkan dapat menjadi dasar awal untuk navigasi robot di area bertingkat atau tidak rata, seperti bangunan runtuh pasca gempa.
