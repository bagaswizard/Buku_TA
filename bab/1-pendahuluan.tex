...
Metode \emph{layered costmap} yang diusulkan dalam tugas akhir telah digunakan sebagai bagian dari sistem navigasi robot otonom Pada penelitian-penelitian terdahulu. Perbedaan disini terletak pada penambahan \emph{layer} baru yang digunakan pada navigasi robot di lingkungan bertingkat, dimana belum dieksplorasi pada penelitian sebelumnya. Selain
