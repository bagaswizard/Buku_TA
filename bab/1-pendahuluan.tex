...
\begin{enumerate}
  \item Bagaimana cara untuk merepresentasikan informasi lingkungan yang terdiri dari beberapa lantai menggunakan \emph{layered} \emph{costmap} untuk bisa digunakan pada algoritma navigasi antar lantai?
  ...
  \item Apakah dengan menggunakan metode navigasi antar lantai, robot darat otonom dapat melakukan navigasi hingga mencapai tujuan pada arena lab?
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Algoritma navigasi yang digunakan digunakan pada kondisi lingkungan yang rintangan statis sudah diketahui.
\end{enumerate}
