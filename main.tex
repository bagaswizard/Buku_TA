...
\usepackage{svg}
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, shapes.misc, arrows.meta, fit, positioning, backgrounds}
\usepackage{svg}
...
% Lembar pengesahan
\includepdf[pages=1]{lainnya/Lembar_pengesahan.pdf}
% \input{lainnya/lembar-pengesahan.tex}
\cleardoublepage
% \input{lainnya/lembar-pengesahan-en.tex}
\includepdf[pages=1]{lainnya/approval_sheet.pdf}

\cleardoublepage

% Pernyataan keaslian
\includepdf[pages=1]{lainnya/penyataan_originalitas.pdf}
% \input{lainnya/pernyataan-keaslian.tex}
\cleardoublepage
% \input{lainnya/pernyataan-keaslian-en.tex}
\includepdf[pages=1]{lainnya/statement_of_originality.pdf}
\cleardoublepage
...
\includepdf[pages=1-2]{lainnya/pernyataan_etik_AI_Bagas.pdf}
